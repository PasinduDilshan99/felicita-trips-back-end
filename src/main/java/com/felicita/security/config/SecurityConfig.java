package com.felicita.security.config;
...
//                        .requestMatchers("/api/v0/faq/insert-faq-request").hasAuthority("FAQ_REQUEST_CREATE")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3001","http://localhost:3000","http://stg.felicitatrips.com","https://felicitatrips.com","http://admin-stg.felicitatrips.com"));
